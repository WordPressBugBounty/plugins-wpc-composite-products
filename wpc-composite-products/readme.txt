...
- Use Step-by-step and Accordion layout for components
- Use Categories, Tags, or Attributes as the source for component options
...
= 7.8.2 =
* Fixed: PHP Error with PHP version lower than 8.0

= 7.8.1 =
* Fixed: Error on the WC Blocks
...
= 7.5.9 =
* Fixed: Missing component products when using SKU
